...
const drawBoard = () => {
  boxes.forEach((box, i) => {
    let styleString = '';
    if (i < 3) {
      styleString += 'border-bottom: 5px solid var(--text);';
    }
    if (i % 3 === 0) {
      styleString += 'border-right: 5px solid var(--text);';
    }
    if (i % 3 === 2) {
      styleString += 'border-left: 5px solid var(--text);';
    }
    if (i > 5) {
      styleString += 'border-top: 5px solid var(--text);';
    }
